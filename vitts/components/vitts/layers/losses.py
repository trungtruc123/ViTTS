...
from vitts.components.vitts.utils.ssim import ssim
from vitts.utils.audio import TorchSTFT
    ...
    def forward(
        ...
        if self.use_capacitron_vae:
            ...
            return_dict["capaciton_reconstruction_loss"] = (
                                                                   self.criterion_capacitron_reconstruction_loss(
                                                                       decoder_output, mel_input) / decoder_output.size(
                                                               0)
                                                           ) + kl_capacity
