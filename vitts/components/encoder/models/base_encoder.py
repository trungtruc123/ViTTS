...
from vitts.components.encoder.layers.losses import AngleProtoLoss, GE2ELoss, SoftmaxAngleProtoLoss
from vitts.utils.generic_utils import set_init_dict
...
class BaseEncoder(nn.Module):
    ...
    def load_checkpoint(
        ...
        try:
            ...
            model_dict = set_init_dict(model_dict, state["model"], config)
