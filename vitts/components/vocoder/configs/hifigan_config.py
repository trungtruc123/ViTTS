...
from vitts.utils.config.share_vocoder_config import BaseGanVocoderConfig


@dataclass
class HifiganConfig(BaseGanVocoderConfig):
    """
    Papers: https://arxiv.org/pdf/2010.05646.pdf
    Define paramters for FullBand MelGAN vocoder
